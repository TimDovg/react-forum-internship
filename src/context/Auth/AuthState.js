...
import {CLEAR_ALL_STATE, REMOVE_ADMIN, REMOVE_EMAIL, REMOVE_TOKEN, SET_ADMIN, SET_EMAIL, SET_TOKEN} from "../types";
...
export const AuthState = ({children}) => {
    ...
    return (
        <AuthContext.Provider value={{
            state,
            setToken, removeToken, setAdmin, removeAdmin, setEmail, removeEmail, clearAllState
        }}>
            {children}
